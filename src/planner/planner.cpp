...
const char* kOutlineSystemPrompt =
    ...
    "Rules:\n"
    "- Judge purely from the hunk's own diff (and read_file for extra context if needed) — no "
    "commit history is available or needed here.\n"
    ...
    "diff alone isn't enough context to classify it.";
